...
###
### This script is from EECS 373 last semester. It gives an example of
### how to automate the running of testbenches, validate the output, and
### even print a nice color status!
###
