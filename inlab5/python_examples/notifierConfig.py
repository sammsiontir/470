...
###
### This file is an example of a python library. It is not a stand-alone program
### The NotifierConfigWindow class is an example of how to build a GTK window in
### python. The base NotifierConfig class is a general configuration abstraction
###
### If you're interested, the whole program is here:
###     https://github.com/ppannuto/gmail-notifier
###
...
class NotifierConfigWindow:
	...
	def buildWindow(self):
		...
		try:
			self.window.set_icon_from_file ('/usr/share/gmail-notifier/icons/nomail.png')
		except:
			pass
...
class NotifierConfig:
	...
	def __init__(self, files, onNewGConn=None, onNewGConnArgs=None, onDeleteGConn=None, onDeleteGConnArgs=None):
		...
		self.Keyring = gmailKeyring.Keyring ('gmail-notifier', 'mail.google.com', 'https')
