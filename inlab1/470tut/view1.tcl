...
# DVE full session
# Saved on Fri Jan 11 11:47:39 2013
# Designs open: 1
#   Sim: dve
...
#<Session mode="Full" path="/afs/umich.edu/user/c/h/chengfu/Desktop/470tut/view1.tcl" type="Debug">
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{206 56} {1359 1198}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 174} {height 816} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_col1 0} {child_hier_col2 1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 174} {height 816} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${DriverLoad.1} {{left 0} {top 0} {width 833} {height 179} {dock_state bottom} {dock_on_new_line false}}
...
gui_show_window -window ${TopLevel.2} -show_state normal -rect {{1341 300} {2528 1343}}
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 344} {child_wave_right 838} {child_wave_colname 170} {child_wave_colvalue 170} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sim_run Ucli -exe dve -args {-ucligui  +v2k +vc +memcbk} -dir ../470tut -nosource
}
}
...
gui_sg_addsignal -group ${Group1} { testbench.tbp.reset }
set Group2 Group2
gui_sg_create ${Group2}
gui_sg_addsignal -group ${Group2} { testbench.prediction testbench.taekn testbench.clock testbench.reset testbench.taken testbench.transition testbench.bigsignal testbench.tbp.clock testbench.tbp.reset testbench.tbp.taken testbench.tbp.transition testbench.tbp.prediction testbench.tbp.state testbench.tbp.next_state }
gui_set_radix -radix {hex} -signals {Sim:testbench.bigsignal}
gui_set_radix -radix {unsigned} -signals {Sim:testbench.bigsignal}
...
catch { gui_list_select -id ${Data.1} {testbench.prediction testbench.taekn testbench.clock testbench.reset testbench.taken testbench.transition testbench.bigsignal }}
...
gui_open_source -id ${Source.1}  -replace -active testbench tut_test.v
...
gui_wv_zoom_timerange -id ${Wave.1} 0 100
...
gui_get_drivers -session -id ${DriverLoad.1} -signal testbench.clock -time 20
gui_get_drivers -session -id ${DriverLoad.1} -signal testbench.transition -time 57
gui_get_drivers -session -id ${DriverLoad.1} -signal testbench.prediction -time 29
gui_get_drivers -session -id ${DriverLoad.1} -signal testbench.prediction -time 31
gui_get_drivers -session -id ${DriverLoad.1} -signal testbench.prediction -time 26
gui_get_drivers -session -id ${DriverLoad.1} -signal {testbench.tbp.next_state[1:0]} -time 26
gui_get_drivers -session -id ${DriverLoad.1} -signal testbench.taken -time 26
